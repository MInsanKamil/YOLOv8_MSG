...
from ultralytics.nn.modules.conv import(Concat_AdjustSize,Conv_Fractional_Max_Pooling,Conv_Stride_Attn_Pooling,Conv_Attn_Avg_Pooling,Conv_Attn,Conv_Attn_Pooling_SpatialFirst,Conv_Avg_Attn_Pooling,Conv_Avg_Pooling,Conv_Attn_Pooling_Dropout,Conv_Attn_Pooling,Conv_Avg_Poolingv2,Conv_Spatial_Max_Pooling_Dropout,GhostConv_Modification,Conv_Max_Pooling_Dropout,Conv_Max_Pooling, Conv_Spatial_Max_Pooling)
from ultralytics.nn.modules.head import(Detect_GhostModule, Detect_GhostModule_Modfication)
from ultralytics.nn.modules.block import(CBAM_C2f, CA_C2f, C2f_Max_Pooling, C2f_Fractional_Max_Pooling, SPPF_Attn)
...
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect, Detect_GhostModule, Detect_GhostModule_Modfication)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
